...
class CursorAIGuardian:
    ...
    def record_session_activity(
        self, user_message: str, ai_response: str = None, approved: bool = True
    ) -> None:
        """セッション活動を記録"""
    ...
    def update_project_progress(
        ...
        self.memory_system.update_project_state(
            completed_tasks=completed, new_tasks=new_tasks, current_focus=focus
        )
    ...
    def _prompt_user_intent(self) -> str:
        ...
        print(
            "例: 'バックアップシステムの改善', '新機能の実装', '論文検索システムの拡張'"
        )
