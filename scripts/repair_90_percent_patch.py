...
def execute_repairs_90_percent_patch(threats):
    ...
    for threat in threats:
        ...
        # 安全に修復できるもの
        if ('.tmp' in file_path or '__pycache__' in file_path or 
            '.DS_Store' in file_path or 'temp' in file_path):
            try:
    ...
    success_rate = (actual_repairs / total_threats * 100) if total_threats > 0 else 100.0
