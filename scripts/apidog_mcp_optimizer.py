...
class APIdogMCPOptimizer:
    ...
    def _test_filesystem_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "message": "filesystem server test failed",
                "error": str(e),
            }
    ...
    def _test_openapi_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "message": "OpenAPI server test failed",
                "error": str(e),
            }
    ...
    def _test_git_server(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "success": False,
                "message": "Git server test failed",
                "error": str(e),
            }
    ...
    def _test_error_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "missing_features": [
                    f for f in required_features if f not in enabled_features
                ],
            }
            ...
            return {
                "success": False,
                "message": "Error analysis test failed",
                "error": str(e),
            }
    ...
    def _test_memory_integration(self) -> Dict[str, Any]:
        ...
        try:
            ...
            existing_files = [
                f for f in memory_files if (self.project_root / f).exists()
            ]
            ...
            if len(existing_files) == len(memory_files):
                try:
                    ...
                    success = (
                        result.returncode == 0
                        and "統合記憶システム起動完了" in result.stdout
                    )
                ...
                return {
                    ...
                    "existing_files": existing_files,
                    "missing_files": [
                        f for f in memory_files if f not in existing_files
                    ],
                }
            ...
            return {
                "success": False,
                "message": "Memory integration test failed",
                "error": str(e),
            }
    ...
    def apply_optimizations(self) -> Dict[str, Any]:
        ...
        if test_result["overall_success"]:
            ...
            final_result = {
                ...
                "issues": [
                    r
                    for r in test_result["test_results"].values()
