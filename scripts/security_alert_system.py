...
class SecurityAlertSystem:
    ...
    def load_threat_patterns(self) -> Dict:
        ...
        return {
            ...
            "critical_directories": [".git", "config", "secrets", "private", ".ssh"],
        }
...
"""
            ...
            success = self.email_notifier.send_emergency_alert(
                alert_type=f"脅威レベル {alert['threat_level']}", details=alert_details
            )
    ...
    def run_comprehensive_scan(self) -> Dict:
        ...
        print(
            f"🔍 セキュリティスキャン完了: {alert['threat_level']} ({alert['total_threats']}件の脅威)"
        )
