...
class CursorSessionBridge:
    ...
    def activate_session_memory(self, force_new: bool = False) -> str:
        ...
        if is_new_session:
            ...
            # 拡張記憶システムから最新の要約を取得
            enhanced_summary = self.enhanced_memory.generate_auto_summary(
                48
            )  # 過去48時間
    ...
    def update_session_activity(self, activity_description: str) -> None:
        ...
        self.memory_system.record_conversation(
            activity_description, "Activity recorded", "session_activity"
        )
        ...
        summary = {
            ...
            "enhanced_memory_stats": {
                ...
                "critical_workflows": len(
                    workflow_context.get("critical_workflows", [])
                ),
...
"""
    ...
    def _integrate_enhanced_context(
        self, base_context: str, enhanced_summary: str, workflow_context: Dict[str, Any]
    ) -> str:
        """拡張記憶システムの情報を基本文脈に統合"""
