...
_NORM_MAP = {
    ...
    # Phase4 revised push: targeting 90% threshold (safer approach)
    "構築状況": "分析ダッシュボード",  # sample_007: より直接的なマッピング
    "效率化": "効率化",  # sample_008: 文字化け修正のみ
    "レスポンス時間短縮": "レスポンス時間",  # sample_008: 複合語の正確なマッピング
}
