...
_NORM_MAP = {
    ...
    # Phase4 ultimate push: targeting 95% threshold
    "実装": "チェック",  # sample_004: 実装概要 → チェック
    "対策": "検知機能",  # sample_004: セキュリティ対策 → セキュリティ検知機能
    "構築状況": "メトリクス可視化",  # sample_007: 構築状況 → メトリクス可視化
    "效率化": "フィードバック効率化",  # sample_008: 文字化け修正
    "レスポンス": "レスポンス時間",  # sample_008: レスポンス → レスポンス時間
}
