...
class GroqService:
    ...
    def _generate_professional_fallback(self, conversation_text: str) -> str:
        ...
        if any(keyword in text_lower for keyword in ["料金", "価格", "コスト", "費用", "値段", "予算"]):
        ...
        elif any(keyword in text_lower for keyword in ["機能", "サービス", "できる", "使える", "特徴", "メリット"]):
        ...
        elif any(keyword in text_lower for keyword in ["検討", "導入", "考えて", "悩んで", "決める", "選択"]):
        ...
        elif any(keyword in text_lower for keyword in ["比較", "他社", "違い", "どっち", "選ぶ", "競合"]):
        ...
        elif any(keyword in text_lower for keyword in ["問題", "課題", "困って", "悩み", "トラブル", "改善"]):
        ...
        elif any(keyword in text_lower for keyword in ["いつ", "時期", "スケジュール", "期間", "タイミング", "導入時期"]):
        ...
        elif any(keyword in text_lower for keyword in ["デモ", "試用", "トライアル", "体験", "見せて", "実際"]):
        ...
        elif any(keyword in text_lower for keyword in ["こんにちは", "はじめまして", "よろしく", "お疲れ"]):
    ...
    def _detect_business_intent(self, text: str) -> str:
        ...
        if any(keyword in text_lower for keyword in ["料金", "価格", "コスト", "費用", "値段", "予算", "お金"]):
            return "pricing_inquiry"
        
        # Product features and capabilities
        elif any(keyword in text_lower for keyword in ["機能", "サービス", "できる", "使える", "特徴", "仕様", "性能"]):
        ...
        elif any(keyword in text_lower for keyword in ["問題", "課題", "困って", "悩み", "サポート", "ヘルプ", "改善"]):
        ...
        elif any(keyword in text_lower for keyword in ["契約", "合意", "条件", "規約", "約束"]):
    ...
    def _detect_detailed_intent(self, conversation_text: str) -> str:
        ...
        if any(keyword in text_lower for keyword in ["こんにちは", "はじめまして", "お疲れ様", "よろしく"]):
            return "greeting"
        
        # Pricing inquiries
        elif any(keyword in text_lower for keyword in ["料金", "価格", "費用", "コスト", "いくら", "値段"]):
            return "pricing_inquiry"
        
        # Feature inquiries
        elif any(keyword in text_lower for keyword in ["機能", "できること", "特徴", "性能", "使い方"]):
            return "feature_inquiry"
        
        # Decision making
        elif any(keyword in text_lower for keyword in ["検討", "考える", "判断", "決める", "選ぶ"]):
            return "decision_making"
        
        # Objections
        elif any(keyword in text_lower for keyword in ["高い", "難しい", "複雑", "心配", "不安", "問題"]):
            return "objection"
        
        # Time/scheduling
        elif any(keyword in text_lower for keyword in ["忙しい", "時間", "スケジュール", "いつ", "タイミング"]):
            return "scheduling"
        
        # Comparison
        elif any(keyword in text_lower for keyword in ["比較", "他社", "競合", "違い", "メリット"]):
            return "comparison"
        
        # Contract/purchase
        elif any(keyword in text_lower for keyword in ["契約", "購入", "導入", "申し込み", "始める"]):
    ...
    def _analyze_customer_sentiment(self, conversation_text: str) -> str:
        ...
        positive_words = ["良い", "素晴らしい", "便利", "助かる", "興味深い", "期待", "満足", "安心"]
        negative_words = ["心配", "不安", "困る", "難しい", "高い", "複雑", "問題", "厳しい"]
